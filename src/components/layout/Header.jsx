    ...
    <header className='border-b border-border-dark bg-background-dark/50 backdrop-blur-md sticky top-0 z-50'>
      <nav className='px-4 md:px-10 py-3 flex items-center justify-between max-w-300 mx-auto w-full'>
        ...
        <div className='flex items-center gap-4'>
          <button className='flex items-center justify-center rounded-full size-10 bg-surface-dark text-white hover:bg-primary hover:text-background-dark transition-colors duration-200 cursor-pointer'>
            <Settings />
          </button>
          <img
            src={icon}
